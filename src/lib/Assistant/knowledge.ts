...
export const KNOWLEDGE: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    answer:
      ...
      "• Getting in — one person starts a room and becomes the host; their browser is the room, with no server behind it. The first invite is ready as soon as the room opens (People → Share, Copy or QR; one invite per guest). The guest opens it, taps Join and sends back the reply they get (it is copied for them), and the host pastes or scans the reply — the guest is let in as soon as it lands. “This network only” contacts nothing outside the Wi-Fi; “Anywhere” also asks a public STUN server for the device's address\n" +
