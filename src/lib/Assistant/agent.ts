...
function fallbackReply(): AgentReply {
  return {
    engine: "local",
    text:
      "I didn't catch which part of the workspace you mean. I can explain any of the twelve apps, and things like privacy, offline use, backups, themes and keyboard shortcuts.\n" +
