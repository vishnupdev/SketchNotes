...
export const APPS: AppEntry[] = [
  ...
  },
  {
    ...
    name: "Latest Tech",
    blurb:
      "the newest smartphones, laptops, TVs, monitors, graphics cards, processors, tablets, consoles, smartwatches, headphones and cameras — browsed by kind or by brand, newest first, each with the complete specification the manufacturer publishes and a link to the page it came from, the launch price, the release date and how long ago that was, plus a live feed of what has been newly listed this year and a shortlist that stays in your browser",
  },
  {
    path: "/ocr",
    name: "OCR",
...
export const SITE_KEYWORDS = [
  ...
  "export product specs",
  "spec sheet to csv",
  "compare products side by side table",
  "full specs of a device",
