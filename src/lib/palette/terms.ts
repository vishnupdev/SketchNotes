...
export const APP_SEARCH_TERMS: Record<AppId, string[]> = {
  ...
  watchparty: ["watch party", "watch together", "listen together", "movie night", "sync video", "synced playback", "co-watch", "group watch", "room", "invite", "voice chat", "subtitles", "share screen", "stream a movie", "party"],
  streams: [
    "youtube",
    "music",
    "songs",
