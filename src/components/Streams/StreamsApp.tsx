 ...
 *
 * The player sits in the sticky header rather than floating over the grid, which
 * is what lets it shrink to a bar and keep playing while a long station scrolls
 * underneath. Leaving the app unmounts the frame and stops the sound, so music
 * never follows you into another app.
 */
export function StreamsApp() {
  ...
  return (
    <div className="flex min-h-full flex-col">
      {/* Header and player are one sticky block: stacking two sticky elements
          would mean hard-coding the header's height into the player's offset. */}
      <div className="sticky top-0 z-20 border-b border-border bg-paper">
        <header className="px-[22px] pb-[18px] pt-[22px]">
